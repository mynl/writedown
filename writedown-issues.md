...
* human-understandable one- or two-line summary of problem and diagnosis (existing examples are too detailed and too complicated for me to understand!) in **bold**. This level of summary has been lacking prior to Wed 2026-07-22 iteration.
* Next level indented: developer issues and implementation plan - this is "notes for Claude". Here lies comments more like the ones you have been producing.
...
- [ ]  **[Th 2]**: Pandoc/quarto external run to publish pdf.
