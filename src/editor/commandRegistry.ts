...
export const COMMAND_REGISTRY: Record<string, RegistryEntry> = {
  ...
  sortLinesReverse: { run: sortLinesReverse, label: "Sort lines (reverse)", category: "Editing" },
  sortLinesFromColumn: { run: sortLinesFromColumn, label: "Sort lines (from caret column)", category: "Editing" },
  sortLinesCaseSensitive: { run: sortLinesCaseSensitive, label: "Sort lines (case sensitive)", category: "Editing" },
  ...
  zoomPreviewIn: { run: act(() => s().setPreviewZoom(1)), label: "Preview zoom in", category: "View" },
  ...
  toggleOutline: { run: act(() => s().setOutlineVisible(!s().outlineVisible)), label: "Toggle outline", category: "View" },
  toggleFullscreen: { run: act(() => s().toggleFullscreen()), label: "Toggle full screen", category: "View" },
  toggleDistractionFree: { run: act(() => s().toggleDistractionFree()), label: "Toggle distraction free (full screen, no sidebars)", category: "View" },
